...
func TestCommand_RunWorkflow_Success(t *testing.T) {
	...
	mockTestResult.EXPECT().Get(testapi.TestResultTestSubject).Return(&testapi.TestSubject{})
	mockTestResult.EXPECT().Get(testapi.TestResultSubjectLocators).Return(&[]testapi.TestSubjectLocator{})
	mockTestResult.EXPECT().Get(testapi.TestResultBreachedPolicies).Return(nil)
...
func setupMockTestResultForPrepareOutput(m *gafclientmocks.MockTestResult) {
	...
	m.EXPECT().Get(testapi.TestResultTestSubject).Return(&testapi.TestSubject{}).AnyTimes()
	m.EXPECT().Get(testapi.TestResultSubjectLocators).Return(&[]testapi.TestSubjectLocator{}).AnyTimes()
	m.EXPECT().Get(testapi.TestResultBreachedPolicies).Return(nil).AnyTimes()
	m.EXPECT().Get(testapi.TestResultRawSummary).Return(nil).AnyTimes()
