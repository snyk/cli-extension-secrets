...
func TestStreamAllowedFiles(t *testing.T) {
	...
	t.Run("Input: Single directory path (Respects .gitignore)", func(t *testing.T) {
		...
		stream := streamAllowedFiles(ctx, []string{"."}, []string{gitIgnoreFile}, getCustomGlobIgnoreRules(), false, &logger)
	...
	t.Run("Input: Multiple directory paths", func(t *testing.T) {
		...
		ctx := context.Background()
		stream := streamAllowedFiles(ctx, []string{dirA, dirB}, []string{gitIgnoreFile}, getCustomGlobIgnoreRules(), false, &logger)
	...
	t.Run("Input: Mixed directories and file paths", func(t *testing.T) {
		...
		stream := streamAllowedFiles(ctx, inputs, []string{gitIgnoreFile}, getCustomGlobIgnoreRules(), false, &logger)
	...
	t.Run("Handles context cancellation", func(t *testing.T) {
		...
		stream := streamAllowedFiles(ctx, []string{rootDir}, []string{gitIgnoreFile}, getCustomGlobIgnoreRules(), false, &logger)
		cancel()
